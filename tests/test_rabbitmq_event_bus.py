...
# TODO: Fix imports when aio_pika module is available
...
#         with patch('src.infrastructure.event_bus.rabbitmq_event_bus.aio_pika.connect_robust') as mock_connect:
...
#         )
#         
#         await event_bus.publish("test_queue", event)
#         
