...
The core functionality relies on the `LLMGraphTransformer` module provided by the `langchain-community` package, which will be installed automatically when running `make install`.
